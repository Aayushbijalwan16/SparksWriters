...
const Privacy = () => {
  return (
    <div style={{ padding: '2rem', maxWidth: '800px', margin: 'auto' }}>
      ...
      <h2 className='text-2xl font-bold text-gray-800 mt-4 flex items-center'>1. Information We Collect</h2>
      ...
      <h2 className='text-2xl font-bold text-gray-800 mt-4 flex items-center'>2. How We Use Your Information</h2>
      <ul className='list-inside list-disc text-gray-600 pl-4 space-y-2'>
      ...
      <h2 className='text-2xl font-bold text-gray-800 mt-4 flex items-center'>3. Data Sharing</h2>
      ...
      <h2 className='text-2xl font-bold text-gray-800 mt-4 flex items-center'>4. Cookies</h2>
      <p className='text-gray-600 leading-relaxed'>
      ...
      <h2 className='text-2xl font-bold text-gray-800 mt-4 flex items-center'>5. Data Security</h2>
      <p className='text-gray-600 leading-relaxed'>
        We implement industry-standard measures to protect your data from unauthorized access or disclosure.
      </p>

      <h2 className='text-2xl font-bold text-gray-800 mt-4 flex items-center'>6. Your Rights</h2>
      <p className='text-gray-600 leading-relaxed'>
        You may request to access, correct, or delete your personal data by contacting us at the email below.
      </p>

      <h2 className='text-2xl font-bold text-gray-800 mt-4 flex items-center'>7. Changes to This Policy</h2>
      <p className='text-gray-600 leading-relaxed'>
        We may update this Privacy Policy from time to time. Changes will be posted on this page with an updated date.
      </p>

      <h2 className='text-2xl font-bold text-gray-800 mt-4 flex items-center'>8. Contact Us</h2>
      <p className='text-gray-600 leading-relaxed'>
